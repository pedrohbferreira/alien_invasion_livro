...
def run_game():
    ...
    while True:
        ...
        gf.check_events(ai_settings, screen, stats, btn_play, ship, bullets_group)
        ...
        gf.update_screen(ai_settings, screen, stats, ship, aliens_group, bullets_group, btn_play)
